function love.conf(t)
	t.title = "Lua Mines"				-- The title of the window the game is in (string)
	t.author = "Gehenna"				-- The author of the game (string)
	t.identity = "lua-mines"			-- The name of the save directory (string)
